...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <div class="logo me-auto">
        <h1><a href="HomePage">Orphan</a></h1>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="nav-link scrollto active" href="HomePageDemo">Home</a></li>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="container text-center text-md-left" data-aos="fade-up">
      <h1>United Orphan <span>Home</span></h1>
      <h2>Providing care and support for Orphaned Children</h2>
  ...
  <main id="main">
    ...
    <section id="what-we-do" class="what-we-do">
      <div class="container">
        ...
        <div class="section-title">
          <h2>What We Do</h2>
          <p>Provide care, education, and support for orphaned children</p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="icon-box">
              ...
              <h4><a href="">Care and Supportm</a></h4>
              <p>The primary objective of an orphan home is to provide a safe, nurturing, and supportive environment for
                orphaned children.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="icon-box">
              ...
              <h4><a href="">Education and Skill Development</a></h4>
              <p> Another crucial aspect of orphan homes is providing quality education and skill development
                opportunities to the children</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="icon-box">
              ...
              <h4><a href="">Emotional and Psychological Support</a></h4>
              <p>Orphaned children often face emotional trauma and may require specialized support to overcome their
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <img src="assets/img/about_img1.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0">
            <h3>About Us</h3>
            <p>
              A compassionate refuge for orphaned children, offering love, care, and a brighter future.
            </p>
            <ul>
              <li><i class="bx bx-check-double"></i> Empowering orphaned children through nurturing care and education.
              </li>
              <li><i class="bx bx-check-double"></i> Fostering hope and opportunity for a better tomorrow.</li>
            </ul>
            <div class="row icon-boxes">
              <div class="col-md-6">
                <i class="bx bx-receipt"></i>
                <h4>Mission and Vision</h4>
                <p>This is where they outline their primary goals and values as an organization.</p>
              </div>
              <div class="col-md-6 mt-4 mt-md-0">
                <i class="bx bx-cube-alt"></i>
                <h4>Staff and Expertise</h4>
                <p>This could include information about their qualifications, experience, and expertise in child welfare
                  and development</p>
              </div>
            </div>
          </div>
    ...
    <section id="contact" class="contact section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Contact</h2>
          <p>Support or inquire about our orphan home</p>
        </div>
            ...
            <div class="info-wrap">
              <div class="row">
                ...
                <div class="col-lg-4 info mt-4 mt-lg-0">
                  ...
                  <h4>Call:</h4>
                  <p>+91 9933889091<br>+91 9064055534</p>
                </div>
              </div>
            </div>
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              Beleghata, 700010<br>
              West Bengal <br><br>
              <strong>Phone:</strong> +91 9064055534<br>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Our Services</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Residential Care</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Basic Needs</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Education</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Skill Development</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Recreational Activities</a></li>
            </ul>
          </div>

          <div class="col-lg-4 col-md-6 footer-newsletter">
            <h4>Join Our Newsletter</h4>
            <p>Stay informed and engaged with our orphan home's initiatives by joining our newsletter</p>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>Orphan</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
          ...
          Designed by <a href="https://bootstrapmade.com/">Orphanteam</a>
        </div>
      </div>
